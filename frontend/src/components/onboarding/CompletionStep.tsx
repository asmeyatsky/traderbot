  ...
  return (
    <div className="animate-fade-in text-center">
      <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-indigo-100 dark:bg-indigo-900/40">
        <svg className="h-8 w-8 text-indigo-600 dark:text-indigo-400" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
      ...
      <h2 className="mt-6 text-3xl font-bold text-gray-900 dark:text-white">You're All Set!</h2>
      ...
      <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-3">
        {links.map((l) => (
          <Link
            ...
            className="rounded-lg border border-gray-200 dark:border-gray-600 p-4 text-center transition-colors hover:border-indigo-300 dark:hover:border-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-900/30"
          >
            <l.icon className="mx-auto h-8 w-8 text-indigo-600 dark:text-indigo-400" />
            <div className="mt-2 text-sm font-semibold text-gray-900 dark:text-white">{l.title}</div>
